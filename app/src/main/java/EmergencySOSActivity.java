...
public class EmergencySOSActivity extends AppCompatActivity {
    ...
    private String getPrefsName() {
        return "SOSPrefs_" + currentUserId;
    }
    ...
    private void saveContacts() {
        SharedPreferences.Editor ed = getSharedPreferences(getPrefsName(), MODE_PRIVATE).edit();
    ...
    private void loadSavedContacts() {
        SharedPreferences p = getSharedPreferences(getPrefsName(), MODE_PRIVATE);
